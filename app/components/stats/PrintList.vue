  ...
  <div class="hidden print:block w-full">
    ...
    <ol class="space-y-6">
      <li
        ...
        class="border-b border-gray-300 pb-4 last:border-0"
      >
        <div class="flex items-start justify-between gap-2">
          <div>
            ...
            >
            <span v-if="v.username" class="ml-2 text-sm text-gray-500"
              >@{{ v.username }}</span
            >
          </div>
        ...
        <ul
          ...
          class="mt-1 ml-4 text-sm text-gray-600 list-disc list-inside"
        >
