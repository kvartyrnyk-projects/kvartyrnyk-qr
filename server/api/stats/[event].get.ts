...
export default defineEventHandler(
  async (event): Promise<StatsEventResponse> => {
    ...
    const visitors: VisitorRow[] = visitorRows.map((v) => ({
      ...
      checkedInAt: v.checked_in_at ? v.checked_in_at.toISOString() : null,
      registeredAt: v.created_at ? v.created_at.toISOString() : null,
    ...
    return {
      event: {
        ...
        startsAt: eventRow.starts_at.toISOString(),
